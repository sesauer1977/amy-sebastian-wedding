...
const highlights = [
  { image: `${GH}/el-coast.jpg`, emoji: "🏖", title: "Die Küste", body: "East Lothian hat über 65 km atemberaubende Küstenlinie, von den breiten goldenen Sandstränden von Yellowcraig und Gullane bis zu den dramatischen Klippen bei Tantallon. Der Firth of Forth erstreckt sich vor Dir mit Bass Rock, Heimat der weltgrößten Basstölpel-Kolonie, direkt vor der Küste." },
  { image: `${GH}/el-castle.jpg`, emoji: "🏰", title: "Burgen und Geschichte", body: "East Lothian ist reich an Geschichte. Tantallon Castle, eine Festung aus dem 14. Jahrhundert auf Klippen über dem Meer, ist eine der dramatischsten Ruinen Schottlands. Dirleton Castle, direkt neben dem Hochzeitsgelände, stammt aus dem 13. Jahrhundert und ist von wunderschönen Gärten umgeben." },
  { image: `${GH}/el-golf.jpg`, emoji: "⛳", title: "Weltklasse-Golf", body: "East Lothian ist als Schottlands Golfküste bekannt. Die Region hat 22 Golfplätze innerhalb von 40 km, darunter Muirfield, einer der berühmtesten Golfplätze der Welt und regelmäßiger Austragungsort der Open Championship. Der North Berwick Golf Club, gegründet 1832, ist einer der ältesten der Welt." },
  { image: `${GH}/el-food.jpg`, emoji: "🦞", title: "Essen und Trinken", body: "East Lothian hat eine florierende Gastronomie mit außergewöhnlichen lokalen Produkten. Frische Meeresfrüchte sind überall: Langustinen, Hummer, Krabben und Austern direkt aus dem Firth of Forth. Die Glenkinchie Destillerie, eine der Lowland Whisky Destillerien Schottlands, ist nur 30 Minuten entfernt." },
];
...
const practicalInfo = [
  ...
  { emoji: "🚗", label: "Fortbewegung", detail: "Ein Mietwagen bietet die meiste Flexibilität. Die Gegend ist auch gut zu Fuß und mit dem Fahrrad entlang der Küste erkundbar." },
  { emoji: "📍", label: "Basisort", detail: "North Berwick ist der ideale Ausgangspunkt: eine charmante Hafenstadt mit ausgezeichneten Restaurants, Geschäften und direkten Zügen nach Edinburgh." },
];
    ...
    <section id="east-lothian" style={{ background: "oklch(0.93 0.015 80)", padding: "6rem 1.5rem", scrollMarginTop: "64px" }}>
      <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
        <div className="fade-in-up" style={{ textAlign: "center", marginBottom: "4rem" }}>
          <p style={{ fontFamily: "'Lato', sans-serif", fontSize: "0.7rem", fontWeight: 700, letterSpacing: "0.25em", textTransform: "uppercase", color: "oklch(0.62 0.07 155)", marginBottom: "0.75rem" }}>Bleib ein bisschen länger</p>
          ...
          <p style={{ fontFamily: "'Lato', sans-serif", fontSize: "1rem", color: "oklch(0.45 0.02 80)", maxWidth: "600px", margin: "0 auto", lineHeight: 1.7 }}>
            Wenn Du von weit her anreist oder die Reise einfach auskosten möchtest, ist East Lothian eine der schönsten und unterschätztesten Regionen Schottlands. Hier ist ein Vorgeschmack auf das, was Dich erwartet.
          </p>
        </div>
        ...
        <div className="fade-in-up" style={{ marginTop: "2.5rem", background: "oklch(0.93 0.03 155 / 0.4)", border: "1px solid oklch(0.82 0.05 155)", borderRadius: "0.5rem", padding: "1.5rem 2rem", display: "flex", flexWrap: "wrap", gap: "1rem", alignItems: "center", justifyContent: "space-between" }}>
          <div>
            <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.2rem", fontWeight: 500, color: "oklch(0.28 0.06 155)", marginBottom: "0.25rem" }}>Deinen Aufenthalt planen</p>
            <p style={{ fontFamily: "'Lato', sans-serif", fontSize: "0.85rem", color: "oklch(0.45 0.02 80)" }}>Visit East Lothian bietet umfassende Reiseführer für die Region.</p>
          </div>
