/**
 * GuestInfoSection — Practical guest information: children, dietary, gifts, WhatsApp, save the date
...
const infoCards = [
  {
    ...
    body: "Your children are warmly welcome to join us for the celebration. We want our day to be a joy for the whole family.",
  },
  {
    icon: "🍽",
