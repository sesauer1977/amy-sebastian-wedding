...
const transportCards = [
  {
    ...
    body: "Complimentary coaches will depart from Archerfield at 1:15 pm on Saturday, arriving at Our Lady Star of the Sea in North Berwick in time for the 2:00 pm ceremony. The drive takes approximately 15 minutes. Please be ready to board by 1:10 pm.",
  ...
  },
  {
    ...
    bodyColour: "oklch(0.45 0.02 80)",
    body: "After the ceremony, complimentary coaches will be provided for all guests from the church to The Waterfront at Archerfield. The journey takes approximately 15 minutes. No need to arrange your own transport from the church to the reception.",
    note: "For all guests",
