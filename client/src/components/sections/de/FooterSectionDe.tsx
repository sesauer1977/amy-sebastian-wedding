...
export default function FooterSectionDe() {
  const year = new Date().getFullYear();
  return (
    <footer style={{ background: "oklch(0.28 0.06 155)", padding: "3rem 1.5rem", textAlign: "center" }}>
      <div style={{ maxWidth: "600px", margin: "0 auto" }}>
        ...
        <p style={{ fontFamily: "'Lato', sans-serif", fontSize: "0.75rem", color: "oklch(0.55 0.04 155)", letterSpacing: "0.08em" }}>Mit Liebe gemacht · {year}</p>
      </div>
    </footer>
  );
}
