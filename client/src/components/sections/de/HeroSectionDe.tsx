export default function HeroSectionDe() {
  ...
  return (
    <section style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden" }}>
      <div style={{ position: "absolute", inset: 0, backgroundImage: "url('https://raw.githubusercontent.com/sesauer1977/amy-sebastian-wedding/main/public/images/hero-coast-v2.jpg')", backgroundSize: "cover", backgroundPosition: "center" }} />
      ...
      <div style={{ position: "relative", zIndex: 1, textAlign: "center", padding: "2rem 1.5rem", maxWidth: "700px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "1rem", margin: "1.5rem auto", maxWidth: "300px", opacity: 0, animation: "fadeInUp 0.8s cubic-bezier(0.23, 1, 0.32, 1) 0.6s forwards" }}>
          <div style={{ flex: 1, height: "1px", background: "oklch(0.85 0.05 155 / 0.6)" }} />
          <span style={{ color: "oklch(0.85 0.05 155)", fontSize: "1.2rem" }}>✦</span>
          <div style={{ flex: 1, height: "1px", background: "oklch(0.85 0.05 155 / 0.6)" }} />
        </div>
        <p style={{ fontFamily: "'Cormorant Garamond', serif", fontStyle: "italic", fontSize: "clamp(1.3rem, 3vw, 1.8rem)", color: "oklch(0.92 0.02 85)", marginBottom: "0.5rem", opacity: 0, animation: "fadeInUp 0.8s cubic-bezier(0.23, 1, 0.32, 1) 0.7s forwards" }}>
          Samstag, 8. Mai 2027
        </p>
        <p style={{ fontFamily: "'Lato', sans-serif", fontSize: "0.9rem", fontWeight: 300, letterSpacing: "0.1em", color: "oklch(0.88 0.02 85)", marginBottom: "3rem", opacity: 0, animation: "fadeInUp 0.8s cubic-bezier(0.23, 1, 0.32, 1) 0.85s forwards" }}>
          Archerfield, East Lothian, Schottland
        </p>
        <button onClick={handleScrollDown} style={{ background: "none", border: "1.5px solid oklch(0.85 0.05 155 / 0.7)", borderRadius: "50%", width: "44px", height: "44px", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto", cursor: "pointer", color: "oklch(0.92 0.02 85)", opacity: 0, animation: "fadeInUp 0.8s cubic-bezier(0.23, 1, 0.32, 1) 1.1s forwards" }} aria-label="Nach unten scrollen">
