...
const archerfieldRooms = [
  { type: "Pavilion Suite", qty: "10 verfügbar", sleeps: "Bis zu 2 Personen", rooms: "1 Doppel- oder Zweibettzimmer", price: "£395 pro Nacht", basis: "Übernachtung mit Frühstück", icon: "🛏" },
  { type: "Große Pavilion Suite", qty: "2 verfügbar", sleeps: "Bis zu 2 Personen", rooms: "1 Doppel- oder Zweibettzimmer", price: "£440 pro Nacht", basis: "Übernachtung mit Frühstück", icon: "🛏" },
  { type: "3-Zimmer-Lodge (5 Personen)", qty: "1 verfügbar", sleeps: "Bis zu 5 Personen", rooms: "2 Doppel-/Zweibett + 1 Einzelzimmer", price: "£900 pro Nacht", basis: "Nur Übernachtung", icon: "🏡" },
  { type: "3-Zimmer-Lodge (6 Personen, A)", qty: "2 verfügbar", sleeps: "Bis zu 6 Personen", rooms: "2 Doppel-/Zweibett + 1 Doppelzimmer", price: "£900 pro Nacht", basis: "Nur Übernachtung", icon: "🏡" },
  { type: "3-Zimmer-Lodge (6 Personen, B)", qty: "2 verfügbar", sleeps: "Bis zu 6 Personen", rooms: "3 Doppel- oder Zweibettzimmer", price: "£900 pro Nacht", basis: "Nur Übernachtung", icon: "🏡" },
  { type: "4-Zimmer-Lodge (7 Personen)", qty: "1 verfügbar", sleeps: "Bis zu 7 Personen", rooms: "2 Doppel-/Zweibett + 1 Zweibett + 1 Einzelzimmer", price: "£1.050 pro Nacht", basis: "Nur Übernachtung", icon: "🏰" },
  { type: "4-Zimmer-Lodge (8 Personen)", qty: "2 verfügbar", sleeps: "Bis zu 8 Personen", rooms: "4 Doppel- oder Zweibettzimmer", price: "£1.050 pro Nacht", basis: "Nur Übernachtung", icon: "🏰" },
];

const nearbyAccommodation = [
  { name: "Open Arms Hotel", type: "Hotel", location: "Main Street, Dirleton, EH39 5EG", distance: "ca. 3 km von Archerfield", description: "Charmantes Hotel gegenüber dem Dirleton Castle aus dem 13. Jahrhundert. Hervorragendes Restaurant und herzliche schottische Gastfreundschaft.", price: "ab ca. £100 pro Nacht", url: "https://openarmshotel.com/" },
  { name: "Marine North Berwick", type: "Boutique-Hotel", location: "18 Cromwell Road, North Berwick, EH39 4LZ", distance: "ca. 8 km von Archerfield", description: "Elegantes Boutique-Hotel mit herrlichem Blick auf den Firth of Forth und Bass Rock. Frisch renovierte Zimmer und Spa.", price: "ab ca. £150 pro Nacht", url: "https://marineandlawn.com/marinenorthberwick/" },
  { name: "Greywalls Hotel und Chez Roux", type: "Landhaus-Hotel", location: "Muirfield, Gullane, EH31 2EG", distance: "ca. 3 km von Archerfield", description: "Historisches edwardianisches Landhaus am Rande des Muirfield Golfplatzes. Atemberaubende Aussicht über East Lothian.", price: "ab ca. £350 pro Nacht", url: "https://www.greywalls.co.uk/" },
  { name: "Old Aberlady Inn", type: "Gasthof / B&B", location: "West Mains Street, Aberlady, EH32 0RF", distance: "ca. 5 km von Archerfield", description: "Gemütlicher Dorfgasthof mit Frühstück inklusive. Herzliche Atmosphäre und ausgezeichnete Küche.", price: "ab ca. £120 pro Nacht", url: "https://www.oldaberlady.co.uk/" },
  { name: "Tantallon Caravan und Camping Park", type: "Camping", location: "Dunbar Road, North Berwick", distance: "ca. 8 km von Archerfield", description: "Gut ausgestatteter Campingplatz mit spektakulärem Blick auf den Firth of Forth und direktem Strandzugang.", price: "ab ca. £30 pro Nacht", url: "https://www.meadowhead.co.uk/" },
  { name: "Gilsland Park", type: "Ferienpark / Glamping", location: "North Berwick", distance: "ca. 8 km von Archerfield", description: "Familiengeführter Ferienpark in North Berwick mit Glamping-Hütten und Whirlpool-Lodges.", price: "ab ca. £50 pro Nacht", url: "https://www.gilslandpark.co.uk/" },
  { name: "Airbnb und Ferienwohnungen", type: "Ferienwohnung", location: "North Berwick, Gullane und Umgebung", distance: "Verschiedene Entfernungen", description: "Eine große Auswahl an Ferienwohnungen und Cottages in ganz East Lothian über Airbnb und lokale Agenturen.", price: "ab ca. £80 pro Nacht", url: "https://www.airbnb.com/s/North-Berwick--Scotland" },
  { name: "Hotels in Edinburgh", type: "Hotels", location: "Edinburgh", distance: "ca. 55 km / ca. 1 Std. Taxi", description: "Edinburgh bietet eine riesige Auswahl an Hotels in allen Preisklassen. Die Stadt ist gut mit dem Zug und der Straße erreichbar.", price: "ab ca. £80 pro Nacht", url: "https://www.visitscotland.com/destinations-maps/edinburgh/" },
];

function Row({ label, value }: { label: string; value: string }) {
  return (
    <div style={{ display: "flex", gap: "0.5rem", alignItems: "baseline" }}>
      <span style={{ fontFamily: "'Lato', sans-serif", fontSize: "0.7rem", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: "oklch(0.62 0.07 155)", minWidth: "60px", flexShrink: 0 }}>{label}</span>
    ...
    <section id="accommodation" style={{ background: "oklch(0.97 0.012 85)", padding: "6rem 1.5rem", scrollMarginTop: "64px" }}>
      <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
        <div className="fade-in-up" style={{ textAlign: "center", marginBottom: "4rem" }}>
          <p style={{ fontFamily: "'Lato', sans-serif", fontSize: "0.7rem", fontWeight: 700, letterSpacing: "0.25em", textTransform: "uppercase", color: "oklch(0.62 0.07 155)", marginBottom: "0.75rem" }}>Wo Ihr übernachten könnt</p>
        ...
        <div className="fade-in-up" style={{ marginBottom: "4rem" }}>
          ...
          <div style={{ background: "oklch(0.28 0.06 155)", borderRadius: "0.5rem", padding: "1.25rem 1.5rem", marginBottom: "1rem", display: "flex", gap: "1rem", alignItems: "flex-start" }}>
            ...
            <div>
              ...
              <p style={{ fontFamily: "'Lato', sans-serif", fontSize: "0.88rem", color: "oklch(0.82 0.04 155)", lineHeight: 1.7, margin: 0 }}>
                Alle Zimmer sind großzügig und familienfreundlich gestaltet. Kinder unter 12 Jahren können im Zimmer der Eltern auf Klappbetten schlafen, und mehrere Betten passen problemlos in jeden Raum. Kinder ab 12 Jahren zählen laut Archerfield-Bedingungen als Erwachsene. Die 3-Zimmer-Lodges eignen sich ideal für 3 Familien gemeinsam, die 4-Zimmer-Lodges für 4 Familien.
              </p>
            </div>
          </div>
          ...
          <div style={{ background: "oklch(0.93 0.03 155 / 0.3)", border: "1px solid oklch(0.82 0.05 155)", borderRadius: "0.5rem", padding: "1.25rem 1.5rem", marginBottom: "1rem", display: "flex", gap: "1rem", alignItems: "flex-start" }}>
            ...
            <div>
              ...
              <p style={{ fontFamily: "'Lato', sans-serif", fontSize: "0.88rem", color: "oklch(0.35 0.01 80)", lineHeight: 1.7, margin: 0 }}>
                Die Suiten und Lodges liegen ca. 1,5 bis 3 km vom The Waterfront entfernt. Archerfield bietet einen Rund-um-die-Uhr-Shuttle-Service auf dem gesamten Estate an.
              </p>
            </div>
          </div>
          ...
          <div style={{ background: "oklch(0.93 0.03 155 / 0.3)", border: "1px solid oklch(0.82 0.05 155)", borderRadius: "0.5rem", padding: "1.25rem 1.5rem", marginBottom: "1.5rem", display: "flex", gap: "1rem", alignItems: "flex-start" }}>
            ...
            <p style={{ fontFamily: "'Lato', sans-serif", fontSize: "0.9rem", color: "oklch(0.35 0.01 80)", lineHeight: 1.7 }}>
              Zur Buchung von Unterkünften auf dem Archerfield Estate wendet Euch bitte direkt an Tracy:{" "}
              ...
              . Bitte erwähnt, dass Ihr Gäste bei der Hochzeit von Amy und Sebastian seid.
            </p>
          </div>
              ...
              <div key={room.type} style={{ background: "oklch(1 0 0)", borderRadius: "0.4rem", padding: "1.25rem 1.5rem", boxShadow: "0 2px 12px oklch(0.28 0.06 155 / 0.06)", border: "1px solid oklch(0.92 0.01 100)" }}>
                ...
                <div style={{ borderTop: "1px solid oklch(0.92 0.01 100)", paddingTop: "0.75rem" }}>
                  <div style={{ display: "flex", flexDirection: "column", gap: "0.3rem" }}>
                    <Row label="Personen" value={room.sleeps} />
        ...
        <div className="fade-in-up">
          ...
          <p style={{ fontFamily: "'Lato', sans-serif", fontSize: "0.9rem", color: "oklch(0.45 0.02 80)", lineHeight: 1.75, marginBottom: "1.5rem" }}>
            North Berwick liegt nur 10 Minuten mit dem Auto von Archerfield entfernt und bietet eine große Auswahl an Unterkünften für jeden Geschmack und jedes Budget. Von erstklassigen Golfresorts und Boutique-Hotels bis hin zu gemütlichen B&Bs, Ferienwohnungen, Airbnbs und Campingplätzen direkt an der Küste. Sogar Edinburgh mit seiner riesigen Hotelauswahl ist nur etwa eine Stunde mit dem Taxi entfernt.
          </p>
